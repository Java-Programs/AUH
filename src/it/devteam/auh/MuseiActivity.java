 ...
 * 
 */
public class MuseiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// -- Ottengo i valori.
		InputStream is = this.getResources().openRawResource(R.raw.musei);
		ArrayList<ContentValues> arrayList = LibUtil.getValueFromCSV(is, 4, 19);
