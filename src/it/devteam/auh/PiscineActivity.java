 ...
 *
 */
public class PiscineActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		// -- Ottengo i valori.
		InputStream is = this.getResources().openRawResource(R.raw.piscine);
		ArrayList<ContentValues> arrayList = LibUtil.getValueFromCSV(is, 4, 14);
