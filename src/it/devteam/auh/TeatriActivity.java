 ...
 *
 */
public class TeatriActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		// -- Ottengo i valori.
		InputStream is = this.getResources().openRawResource(R.raw.teatri);
		ArrayList<ContentValues> arrayList = LibUtil.getValueFromCSV(is, 4, 15);
