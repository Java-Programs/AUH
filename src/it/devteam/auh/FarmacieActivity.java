 ...
 * 
 */
public class FarmacieActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// -- Ottengo i valori.
		InputStream is = this.getResources().openRawResource(R.raw.farmacie);
		ArrayList<ContentValues> arrayList = LibUtil.getValueFromCSV(is, 0, 7);
